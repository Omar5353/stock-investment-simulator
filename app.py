...
# PNG export: browser-side via Plotly.js — no server deps, works everywhere.
# The 📷 camera icon in the chart toolbar downloads a hi-res PNG directly.
...
with _dl1:
    st.markdown(
        "<small style='color:#6c7086'>📷 Click the <b>camera icon</b> "
        "in the chart toolbar above to download a hi-res PNG.</small>",
        unsafe_allow_html=True,
    )

# Interactive HTML — no server deps
with _dl2:
